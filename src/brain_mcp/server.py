...
Creates and configures the FastMCP server with all tools
and prompts.
"""
...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Provides tools for navigating, searching, creating, "
        "and updating notes. New notes should go to Notes/ "
        "by default and be promoted during review."
    ),
)
